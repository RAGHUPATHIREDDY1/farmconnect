...
_Last synced: 2026-06-04T14:17:08.749Z._
...
- `c:\Users\raghu\OneDrive\Desktop\farmconnect\farmconnect\.mcp.json` _(workspace: farmconnect)_ — _file missing_
...
- **skill-creator** — `C:\Users\raghu\.claude\skills\skill-creator` — Create new skills, modify and improve existing skills. Use when users want to create a skill from scratch, edit, or optimize an existing skill.
