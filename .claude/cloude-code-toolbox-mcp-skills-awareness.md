...
_Generated: 2026-06-04T14:17:08.742Z_
...
Workspace `mcp.json` _(folder: farmconnect)_

- **c:\Users\raghu\OneDrive\Desktop\farmconnect\farmconnect\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\raghu\.claude.json** — _File missing_
...
- **skill-creator** — `C:\Users\raghu\.claude\skills\skill-creator`
